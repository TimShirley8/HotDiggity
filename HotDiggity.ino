...
void setup() {
  ...
  hd.hds.begin(HdSerial::ports::serusb);     // using USB CDC Serial
  //hd.hds.begin(HdSerial::ports::ser0);       // using serial debug port
  if(hd.begin() == false){
...
/* =================================================================================
  ...
  *** DONE list ******
   ...
   - add SerialUSB or Serial.available() to the HdSerial class
